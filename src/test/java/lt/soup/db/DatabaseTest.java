...
public abstract class DatabaseTest {
    ...
    public void setUp(){
        ...
        vilniusWeatherDataMin.setLevel(Level.MIN);
        ...
        vilniusWeatherDataMax.setLevel(Level.MAX);
    ...
    public void shouldSaveToDatabase(){
        ...
        assertThat(database.findById(1L).getLevel(), is(Level.MAX));
        assertThat(database.findById(2L).getLevel(), is(Level.MIN));
        assertThat(database.findById(1L).getLevel(), is(vilniusWeatherDataMax.getLevel()));
